...
func main() {
	...
	if utils.ArrayContains(authReqInfo.Actions, PullKeyWord) {
		fmt.Println("The user " + authReqInfo.Account + " requesting \"pull\" access for the Repo: " + authReqInfo.Name)
		os.Exit(utils.ErrorExitCode)
	}
